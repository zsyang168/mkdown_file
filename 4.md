...
![dpkt](picture/dpkt-parser.png)
## 4.1 IP流量何去何从？－－用Python回答

### 4.1.1使用PyGeoIP关联IP地址的物理位置
...
![google-earth1](picture/google-earth1.png)
![google-earth2](picture/google-earth2.png)
![google-earth3](picture/google-earth3.png)
